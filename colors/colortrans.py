...
def background_contrast(rgb):
	'''
	Return which of black or white maximises contrast on the provided color.
	'''
	parts = [ int(h, 16) for h in re.split(r'(..)(..)(..)', rgb)[1:4] ]
	values = []
	for part in parts:
		part = part / 255.0
		c = part / 12.92 if part <= 0.03928 else ((part + 0.055) / 1.055) ** 2.4
		values.append(c)
	r, g, b = values
	luminance = 0.2126 * r + 0.7152 * g + 0.0722 * b

	return 8 if luminance > 0.179 else 7
